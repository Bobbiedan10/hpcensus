...
import DeleteEnumeratorView from "../../../../components/views/delete-enumerator-view";
import Link from "next/link";
import { useRouter } from "next/router";
function DeleteEnumerator(props) {
      ...
      <div className='mx-auto lg:h-screen'>
        <div className='grid lg:grid-cols-6 h-full'>
          ...
          <div className='lg:mt-14 lg:col-span-5 flex flex-col'>
            ...
            <div>
              <DeleteEnumeratorView id={id} identity={identity} />
            </div>
          </div>
        </div>
      </div>
...
export default DeleteEnumerator;
